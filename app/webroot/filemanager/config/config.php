...
$upload_dir = '/files/uploads/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../files/uploads/'; // relative path from filemanager folder to upload folder (with final /)
